...
1. Find path `aicup/fast\_reid/fastreid/layers` add `cbam.py`   
2. Modify `\_\_init\_\_.py`, add `from .cbam import CBAM` at the last row.   
3. Find path aicup/fast\_reid/fastreid/modeling/backbones/resnet.py and modify.   
